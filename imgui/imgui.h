...
enum ImGui_EditorFlags_
{
	ImEditorFlags_None = 0,
	ImEditorFlags_NewTabs = 1 << 0,
	ImEditorFlags_NewSlider = 1 << 1,
};
...
namespace ImGui
{
	namespace Editor
	{
		void PushFlags( ImGui_EditorFlags_ uFlag );
		void PopFlags();
		ImU32 InterporlateColor( float& fTime, const float& fDuration, const ImVec4& vStartColor, const ImVec4& vEndColor );
	}
}
